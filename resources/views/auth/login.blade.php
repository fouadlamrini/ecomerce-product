...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .title { font-size: 48px; line-height: 1.05; font-weight: 800; color: #111827; margin: 0 0 30px; letter-spacing: -0.03em; }
        .error-list {
            margin-bottom: 16px;
            border-radius: 12px;
        ...
        .meta-link { margin-top: 16px; font-size: 13px; color: #4b5563; }
        ...
        <div class="auth-card">
            <div class="auth-left">
                <div class="auth-form-wrap">
                    ...
                    <p class="muted reveal reveal-2">Welcome back</p>
                    <h1 class="title reveal reveal-3">Sign in</h1>
                    ...
                    <form method="POST" action="{{ route('login.store') }}" class="reveal reveal-5">
                        @csrf
                    ...
                    <p class="meta-link reveal reveal-6">I don't have an account? <a href="{{ route('register') }}">Sign up</a></p>
                </div>
            </div>
