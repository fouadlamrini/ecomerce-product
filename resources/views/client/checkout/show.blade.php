...
@section('content')
    ...
    <div class="grid grid-cols-1 items-start gap-6 lg:grid-cols-[1fr_340px]">
        <div class="rounded-xl border border-slate-200 bg-white p-4.5">
            ...
            <h2 class="mb-3 mt-5.5 text-base font-extrabold">Payment (demo)</h2>
            <button type="button" class="mt-4 w-full rounded-lg bg-[#f16743] px-3 py-3 text-[15px] font-extrabold text-white" id="checkout-demo-pay">Place order (demo)</button>
            <script>
